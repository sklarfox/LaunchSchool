...
postcard = Postcard.new('Greetings from Silicon Valley!!!!')
binding.pry
puts johns_postal_service
puts johns_postal_service.send(ellens_postal_service.street_address, postcard)
